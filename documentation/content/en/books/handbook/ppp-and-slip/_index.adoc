...
For dual-core systems or initial testing:
...
net.graph.pppoe_lb.governor.enabled=1
net.graph.pppoe_lb.governor.mode=1
net.graph.pppoe_lb.governor.min_workers=4
net.graph.pppoe_lb.governor.max_workers=0
net.graph.pppoe_lb.governor.cpu_threshold=70
net.graph.pppoe_lb.governor.cpu_low_threshold=40
net.graph.pppoe_lb.governor.scale_up_interval=5
net.graph.pppoe_lb.governor.scale_down_interval=120
net.graph.pppoe_lb.governor.sess_per_worker=1000
....
